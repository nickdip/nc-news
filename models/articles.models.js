...
exports.insertArticle = ({ title, body, topic, author, article_img_url }) => {
    ...
    return db.query(`INSERT INTO articles (title, body, topic, author, article_img_url, created_at, ) VALUES ($1, $2, $3, $4, $5) RETURNING *`, [title, body, topic, author, article_img_url])
